...
public class NimUserInfoProvider implements UserInfoProvider {
    private static final String TAG = "NimUserInfoProvider";
    ...
    public Bitmap getAvatarForMessageNotifier(SessionTypeEnum sessionType, String sessionId) {
        ...
        Log.i(TAG, "getAvatarForMessageNotifier: " + LogConfig.Notify.notify_head + bm);
        return bm;
    }
    ...
    public String getDisplayNameForMessageNotifier(String account, String sessionId, SessionTypeEnum sessionType) {
        ...
        Log.i(TAG, "getDisplayNameForMessageNotifier: " +  LogConfig.Notify.notify_name + nick);
