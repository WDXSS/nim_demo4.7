...
import com.netease.nim.uikit.LogConfig;
...
class NimSDKOptionConfig {
    ...
    private static MessageNotifierCustomization messageNotifierCustomization = new MessageNotifierCustomization() {
        ...
        public String makeNotifyContent(String nick, IMMessage message) {
            Log.i(TAG, "makeNotifyContent: " + LogConfig.Notify.notify_im_msg + "昵称 ："+ nick +",内容 = "+ message.getContent());
            //通知栏显示的信息
            return "makeNotifyContent"; // 采用SDK默认文案
        }

        @Override
        public String makeTicker(String nick, IMMessage message) {
            Log.i(TAG, "makeTicker: " + LogConfig.Notify.notify_im_msg + "昵称 ："+ nick +",内容 = "+ message.getContent());
            //状态栏显示的内容
            return "makeTicker"; // 采用SDK默认文案
        }

        @Override
        public String makeRevokeMsgTip(String revokeAccount, IMMessage item) {
            Log.i(TAG, "撤回makeRevokeMsgTip: "+ LogConfig.Notify.notify_im_msg + "昵称 ："+ item.getFromNick() +",内容 = "+ item.getContent());
